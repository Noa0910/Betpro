...
function recalcDaySummary() {
  ...
  const fee = parseFloat(summary.dataset.retiroFee || "17") || 17;
  ...
  const feeRow = summary.querySelector("[data-fee-row]");
  if (feeRow) feeRow.classList.toggle("hidden", numRetiros <= 0);
